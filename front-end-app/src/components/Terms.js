...
const Terms = () => {
  ...
  return (
    <div className="form-container">
      ...
      <p>Welcome to Empowered Conversation!</p>

      <p>
        These terms and conditions outline the rules and regulations for the use
        of Empowered Conversation's Website, located at
        https://zealous-williams-0d9378.netlify.com/.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use empowered conversation if you do not
      ...
      <p>
        We employ the use of cookies. By accessing empowered conversation, you
        agreed to use cookies in agreement with the empowered conversation's
        Privacy Policy.
      </p>
      ...
      <p>
        Unless otherwise stated, empowered conversation and/or its licensors own
        the intellectual property rights for all material on empowered
        conversation. All intellectual property rights are reserved. You may
        access this from empowered conversation for your own personal use
        subjected to restrictions set in these terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from empowered conversation</li>
        <li>Sell, rent or sub-license material from empowered conversation</li>
        <li>
          Reproduce, duplicate or copy material from empowered conversation
        </li>
        <li>Redistribute content from empowered conversation</li>
      </ul>
      ...
      <p>
        ...
        empowered conversation does not filter, edit, publish or review Comments
        prior to their presence on the website. Comments do not reflect the
        views and opinions of empowered conversation,its agents and/or
        ...
        laws, empowered conversation shall not be liable for the Comments or for
      ...
      <p>
        empowered conversation reserves the right to monitor all Comments and to
      ...
      <p>
        You hereby grant empowered conversation a non-exclusive license to use,
      ...
      <p>
        ...
        the hyperlink compensates the absence of empowered conversation; and (d)
      ...
      <p>
        ...
        e-mail to empowered conversation. Please include your name, your
      ...
      <p>
        No use of empowered conversation's logo or other artwork will be allowed
      ...
      <div>
        <input type="checkbox" />
        <label for="scales">I accept the Terms and Conditions</label>
      </div>
